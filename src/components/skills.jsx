...
const skillGroups = [
  {
    ...
    skills: [
      ...
      { name: "Adobe XD", level: 86 },
      { name: "Adobe Acrobat", level: 88 },
      { name: "Figma", level: 88 },
      { name: "Canva", level: 92 },
    ],
  },
...
const tools = [
  ...
  { name: "InDesign",     color: "#FF3366", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/indesign/indesign-plain.svg" },
  { name: "After Effects",color: "#9999FF", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/aftereffects/aftereffects-original.svg" },
  { name: "Premiere Pro", color: "#ea77ff", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/premierepro/premierepro-original.svg" },
  { name: "Adobe XD",     color: "#FF61F6", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/xd/xd-plain.svg" },
  { name: "Lightroom",    color: "#31A8FF", icon: "https://cdn.simpleicons.org/adobelightroom/31A8FF" },
  { name: "Audition",     color: "#00E4BB", icon: "https://cdn.simpleicons.org/adobeaudition/00E4BB" },
  { name: "Acrobat",      color: "#EC1C24", icon: "https://cdn.simpleicons.org/adobeacrobatreader/EC1C24" },
  // Other Design
  { name: "Figma",        color: "#F24E1E", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/figma/figma-original.svg" },
  { name: "Canva",        color: "#00C4CC", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/canva/canva-original.svg" },
  // Dev
  { name: "HTML/CSS",     color: "#E34F26", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original.svg" },
  ...
  { name: "Google Workspace", color: "#4285F4", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/google/google-original.svg" },
];
  ...
  return (
    <div style={{ marginBottom: "1.1rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.4rem" }}>
        <span style={{ fontSize: "0.82rem", color: "var(--white)" }}>{name}</span>
        <span style={{
      ...
      <div style={{ height: 3, background: "var(--border)", borderRadius: "2px", overflow: "hidden" }}>
        <motion.div
          initial={{ width: 0 }}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          {skillGroups.map((group, gi) => (
            <RevealOnScroll key={group.category} delay={gi * 0.15} direction={gi === 0 ? "left" : gi === 1 ? "up" : "right"}>
              <motion.div
                whileHover={{ borderColor: "var(--gold)", boxShadow: "0 0 30px rgba(201,149,42,0.1)" }}
                style={{
              ...
              >
                <div style={{
                  ...
                  color: "var(--gold)", letterSpacing: "0.1em", marginBottom: "1.5rem",
                  borderBottom: "1px solid var(--border)", paddingBottom: "0.8rem",
                }}>
                  {group.category}
                </div>
